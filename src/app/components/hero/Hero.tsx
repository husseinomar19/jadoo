    ...
    <>
      <div className="flex flex-col justify-between items-center w-full z-10 md:flex-row mt-[20px]">
        <div className="flex-1/2 relative">
          ...
          <p className="text-[20px] font-bold text-[#DF6951] uppercase">
            Best Destinations around the world
          </p>

          <h2
            id="hero-titel"
            className="text-[82px] font-bold  leading-[1.1] text-[#181E4B]"
          >
            Travel, enjoy and live a new and full life
          </h2>

          <p className="text-[14px] text-[#5E6282] tracking-[0.5px] mt-2 font-medium max-w-[390px]">
          ...
          <div className="flex justify-between items-center w-fit gap-[30px] mt-[25px]">
            ...
            <div className="flex justify-center items-center gap-1.5">
              ...
              <p className="text-[#686D77] font-medium text-[17px]">
                Play Demo
              </p>
            </div>
          </div>
